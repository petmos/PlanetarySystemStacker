...
class Ui_JobDialog(object):
    def setupUi(self, JobDialog):
        ...
        self.job_list_widget.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.ExtendedSelection)
        self.job_list_widget.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectionBehavior.SelectRows)
